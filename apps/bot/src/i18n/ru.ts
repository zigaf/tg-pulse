...
export const ru: Dict = {
  ...
  buttons: {
    ...
    teamBranding: '👥 Команда и брендинг',
  ...
  commands: {
    ...
    settings: 'Интеграции, команда, оплата и брендинг',
  ...
  help: {
    ...
    commands: [
      ...
      '/settings открывает интеграции, команду, оплату и брендинг прямо в Telegram',
  ...
  settings: {
    title: 'Настройки',
    intro: 'Интеграции, постбэки, команда, брендинг и оплата открываются прямо в Telegram, браузер не нужен.',
    channelsTitle: 'По каналам',
    channelsHint: 'Интеграции с рекламными кабинетами и постбэки настраиваются для каждого канала отдельно. Нажмите на канал, чтобы открыть его настройки.',
    noChannels: 'Как только канал будет подключён, его интеграции и постбэки появятся здесь.',
    footer: 'Все изменения сохраняются сразу и действуют и для бота.',
  },
